...
urlpatterns = [
    ...
    path('list/<int:pk>/', CategoryDetailAPIView.as_view(), name = 'detail'),
    # example url: /category/list/<slug_name>/update/
    path('list/<int:pk>/update/', CategoryUpdateAPIView.as_view(), name = 'update'),
    # example url: /category/list/<slug_name>/delete/
    path('list/<int:pk>/delete/',CategoryDeleteAPIView.as_view(), name = 'delete'),
