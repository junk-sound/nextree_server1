'''
GET TOKEN
curl -X POST -d "username=staff1&password=4430515s" http://localhost:8000/api/auth/token/
...
curl -H "Authorization: JWT eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyX2lkIjoyLCJ1c2VybmFtZSI6InN0YWZmMSIsImV4cCI6MTUxODE1MjM5MSwiZW1haWwiOiIifQ.A29OIOczz4_mF6qZI9q9cuJJUaDcF2Lq7G07KMG6Yrk" http://127.0.0.1:8000/topic/list/
